 ...
 */ 
     ...
     * @type {String}
     */
    const  PLUGIN_NAME= ('Mano_InputConfigMV');
...
function createGamepad(){
    //TODO:helpText差し込み
    const nintendo=createGamepadLayout("N","Nintendo Like","B","A","Y","X");
    const xbox =createGamepadLayout("X","Xbox Like","A","B","X","Y");
    const playstation=createGamepadLayout("P","PlayStation Like A","×","○","□","△");
    const ps5DualDualSense = createGamepadLayout("PS5_Windows","PlayStation Like B","□","×","○","△");
...
class Window_GamepadConfig_V8 extends Window_Selectable_InputConfigVer{
    ...
    initialize(rect){
        ...
        this._layoutCommand = new V8_Item_LayoutCommand(setting.command.buttonLayout);
